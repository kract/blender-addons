...
bl_info = {
	...
	"version": (1, 0, 0),
	"blender": (4, 2, 0),
	"description": "Custom key maps for view navigation",
	"warning": "",
	"category": "UI",
}
...
class GZR_KEYMAP_AddonPreferences(AddonPreferences):
	...
	def draw(self, context):
		...
		if self.tab_addon_menu == "LINK":
			row = layout.row()
			row.label(text="Link:")
			row.operator("wm.url_open", text="GitHub").url = "https://github.com/kract/blender-addons/tree/main/gzr-keymap"
